...
-- Dumping structure for table mangos-Serenity.npc_vendor_template
...
-- Dumping data for table mangos-Serenity.npc_vendor_template: 46 rows
/*!40000 ALTER TABLE `npc_vendor_template` DISABLE KEYS */;
REPLACE INTO `npc_vendor_template` (`entry`, `item`, `maxcount`, `incrtime`, `ExtendedCost`, `condition_id`) VALUES
	(33238, 44605, 0, 0, 0, 0),
	(33238, 33451, 0, 0, 0, 0),
	(33238, 33454, 0, 0, 0, 0),
	(33238, 35954, 0, 0, 0, 0),
