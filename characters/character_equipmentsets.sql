...
-- Dumping structure for table characters-Nimitz.character_equipmentsets
...
-- Dumping data for table characters-Nimitz.character_equipmentsets: ~0 rows (approximately)
