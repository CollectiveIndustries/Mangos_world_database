...
-- Dumping structure for table mangos-Serenity.dbscripts_on_go_use
...
-- Dumping data for table mangos-Serenity.dbscripts_on_go_use: 44 rows
/*!40000 ALTER TABLE `dbscripts_on_go_use` DISABLE KEYS */;
REPLACE INTO `dbscripts_on_go_use` (`id`, `delay`, `command`, `datalong`, `datalong2`, `buddy_entry`, `search_radius`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`) VALUES
