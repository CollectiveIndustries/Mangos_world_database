...
-- Dumping structure for table mangos-Serenity.mail_loot_template
...
-- Dumping data for table mangos-Serenity.mail_loot_template: 134 rows
/*!40000 ALTER TABLE `mail_loot_template` DISABLE KEYS */;
REPLACE INTO `mail_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES
	(87, 6529, 100, 0, 1, 1, 0),
