...
-- Dumping structure for table scriptdev2-Nimitz.sd2_db_version
...
-- Dumping data for table scriptdev2-Nimitz.sd2_db_version: 1 rows
/*!40000 ALTER TABLE `sd2_db_version` DISABLE KEYS */;
REPLACE INTO `sd2_db_version` (`version`) VALUES
	('ScriptDev2 (for CMaNGOS c12795+) ');
