...
-- Dumping structure for table mangos-Serenity.vehicle_accessory
...
-- Dumping data for table mangos-Serenity.vehicle_accessory: 207 rows
...
REPLACE INTO `vehicle_accessory` (`vehicle_entry`, `seat`, `accessory_entry`, `comment`) VALUES
	...
	(53786, 1, 53789, 'Blazing Monstrosity'),
	(53791, 1, 53792, 'Blazing Monstrosity'),
	...
	(50473, 0, 50472, 'Earthen Ring Shaman'),
	(48476, 0, 48477, 'Earthen Ring Shaman'),
	(27761, 0, 27535, 'Fordragon Battle Steed'),
	(42008, 0, 42010, 'Dark Iron Golem'),
	(39251, 0, 39245, 'Dark Iron Golem'),
	(48805, 0, 48340, 'KTC Waiter'),
	(48805, 1, 48341, 'KTC Waiter'),
	(48805, 2, 48341, 'KTC Waiter'),
	(48805, 3, 48342, 'KTC Waiter'),
	(48805, 4, 48343, 'KTC Waiter'),
	(48806, 0, 48340, 'KTC Waiter'),
	(48806, 1, 48341, 'KTC Waiter'),
	(48806, 2, 48341, 'KTC Waiter'),
	(48806, 3, 48342, 'KTC Waiter'),
	(48806, 4, 48343, 'KTC Waiter'),
	(48721, 0, 48340, 'KTC Waiter'),
	(48721, 1, 48341, 'KTC Waiter'),
	(48721, 2, 48341, 'KTC Waiter'),
	(48721, 3, 48342, 'KTC Waiter'),
	(48721, 4, 48343, 'KTC Waiter'),
	(37598, 0, 37599, 'Gasbot'),
	(37598, 1, 37599, 'Gasbot'),
	(37598, 2, 37599, 'Gasbot'),
	(37598, 3, 37599, 'Gasbot'),
	...
	(48327, 0, 50472, 'Earthen Ring Gryphon'),
	...
	(49683, 0, 49684, 'Wildhammer Stormtalon'),
	(38929, 0, 38928, 'Flying Bomber'),
	(38918, 0, 38869, 'Flying Bomber'),
	(39039, 0, 39041, 'Gnomeregan Stealth Fighter'),
	(39039, 1, 40785, 'Gnomeregan Stealth Fighter'),
	(48197, 0, 48194, 'Dragonmaw Skyclaw on Dragonmaw Black Drake'),
	(50599, 0, 50600, 'Dragonmaw Skyclaw on Dragonmaw Black Drake'),
	(52025, 0, 52026, 'Dragonmaw Skyclaw on Dragonmaw Black Drake'),
	(33651, 5, 34050, 'Rocket (Mimiron Visual)'),
	(33651, 6, 34050, 'Rocket (Mimiron Visual)'),
	(34183, 1, 34184, 'Clockwork Mechanic'),
	(47297, 0, 47296, 'Lumbering Oaf_Normal'),
	(48939, 0, 48940, 'Lumbering Oaf_Heroic'),
	(37978, 0, 37977, 'Triumph War Gryphon'),
	(37974, 0, 37971, 'Desolation Wind Rider'),
