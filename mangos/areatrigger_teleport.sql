...
-- Dumping structure for table mangos-Serenity.areatrigger_teleport
...
-- Dumping data for table mangos-Serenity.areatrigger_teleport: 349 rows
/*!40000 ALTER TABLE `areatrigger_teleport` DISABLE KEYS */;
REPLACE INTO `areatrigger_teleport` (`id`, `name`, `required_level`, `required_item`, `required_item2`, `heroic_key`, `heroic_key2`, `required_quest_done`, `required_quest_done_heroic`, `target_map`, `target_position_x`, `target_position_y`, `target_position_z`, `target_orientation`) VALUES
