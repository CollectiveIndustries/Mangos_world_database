...
-- Dumping structure for table mangos-Serenity.dbscripts_on_creature_death
...
-- Dumping data for table mangos-Serenity.dbscripts_on_creature_death: 32 rows
/*!40000 ALTER TABLE `dbscripts_on_creature_death` DISABLE KEYS */;
REPLACE INTO `dbscripts_on_creature_death` (`id`, `delay`, `command`, `datalong`, `datalong2`, `buddy_entry`, `search_radius`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`) VALUES
