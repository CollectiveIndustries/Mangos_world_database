...
-- Dumping structure for table mangos-Serenity.game_tele
...
CREATE TABLE IF NOT EXISTS `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1545 DEFAULT CHARSET=utf8 COMMENT='Tele Command';

-- Dumping data for table mangos-Serenity.game_tele: 1,539 rows
...
REPLACE INTO `game_tele` (`id`, `position_x`, `position_y`, `position_z`, `orientation`, `map`, `name`) VALUES
	...
	(1493, 5534.08, -3624.69, 1567.04, 5.20932, 1, 'MountHyjal'),
	...
	(1520, 3987.92, -2945.83, 1002.55, 1.94685, 1, 'Firelands'),
	(1521, 8515.63, 714.174, 558.248, 1.57298, 571, 'TrialOfTheCrusader'),
	(1522, 8588.42, 791.888, 558.236, 3.23819, 571, 'TrialOfTheChampion'),
	(1527, -7571.42, -1320.84, 245.537, 4.82323, 0, 'BlackrockCaverns'),
	(1528, -7539.44, -1196.08, 477.769, 1.94431, 0, 'BlackwingDescent'),
	(1529, -4888.41, -4239.17, 827.763, 2.14347, 0, 'TheBastionofTwilight'),
	(1530, -4053.51, -3447.71, 283.403, 0.278495, 0, 'GrimBatol'),
	(1531, -5599.09, 5412.06, -1798.73, 5.715, 0, 'ThroneoftheTides'),
	(1532, -8296.45, -4458.88, -208.44, 0.375153, 1, 'EndTime'),
	(1533, -10210.5, -1837.61, 20.127, 3.14945, 1, 'HallsofOrigination'),
	(1534, -8289.69, -4580.73, -225.664, 4.56163, 1, 'HourofTwilight'),
	(1535, -10679.7, -1307.1, 17.342, 3.40863, 1, 'LostCityoftheTol\'vir'),
	(1536, 1027.44, 628.709, 156.672, 4.96118, 646, 'TheStonecore'),
	(1537, -11513.3, -2309.88, 608.393, 3.80963, 1, 'TheVortexPinnacle'),
	(1538, -8596.36, -4001.64, -205.546, 1.36386, 1, 'WellofEternity'),
	(1539, -1266.98, 1049.99, 106.995, 3.17061, 732, 'BaradinHold'),
	(1540, -8269.14, -4514.72, -219.44, 0.216964, 1, 'DragonSoul'),
	(1541, -11355, 58.1567, 723.882, 1.88463, 1, 'ThroneoftheFourWinds'),
	(1542, -6561.97, 6140.03, -671.059, 3.60665, 0, 'Vashj\'irAbyssalDepths'),
	(1543, -5133.63, 3281.02, -118.449, 2.38226, 0, 'Vashj\'irKelp\'tharForest'),
	(1544, -6114.38, 4292.36, -348.739, 2.93992, 0, 'Vashj\'irShimmeringExpanse');
