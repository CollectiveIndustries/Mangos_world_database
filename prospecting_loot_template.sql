...
-- Dumping structure for table mangos-Serenity.prospecting_loot_template
...
-- Dumping data for table mangos-Serenity.prospecting_loot_template: 137 rows
/*!40000 ALTER TABLE `prospecting_loot_template` DISABLE KEYS */;
REPLACE INTO `prospecting_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES
	(2770, 774, 50, 1, 1, 1, 0),
	(2770, 818, 50, 1, 1, 1, 0),
